...
<script>
   ...
   import china from '@/utils/china'	
    export default {
    	...
    	var color = ['#66ce8f', '#1994d7'];//航线的颜色
    	var series = [];
    	[['成都', XAData], ['西宁', XNData]].forEach(function (item, i) {  
    	    series.push({
    	        name: item[0] + ' Top3',
    	        type: 'lines',
    	        zlevel: 1,
    	        effect: {
    	            ...
    	            period: 6,
    	            trailLength: 0.7,
    	            color: 'rgba(29, 140, 215)',   //arrow箭头的颜色
    	            symbolSize: 3
    	        },
    	        lineStyle: {
    	            normal: {
